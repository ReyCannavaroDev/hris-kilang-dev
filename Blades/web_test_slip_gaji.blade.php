@php
  ...
  $raw = \DB::select("
    select f.periode_awal, k.kode, f.nomor nomor_gaji, f.periode_akhir, f.desc,k.nama_lengkap, k.nik,kd.nama dir, kdi.nama divisi, kde.nama dept, r.* from t_final_gaji_det_rincian r
