...
{   
    ...
    public $heirs       = ["default_users","m_kary","m_kary_group_det","t_cuti","t_cuti_adjustment","t_final_gaji","t_jadwal_kerja_det","t_final_gaji_det","t_kary_salary","t_kary_salary_det_tarif","t_mutasi","t_lembur","t_potongan","t_riwayat_posisi","t_salary_borongan","t_salary_borongan_det_kary","t_perhitungan_gaji","t_sgp","t_spd","t_libur_d","t_bonus","m_hutang_kary","t_cuti_uang"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];
    public $required    = [""];
