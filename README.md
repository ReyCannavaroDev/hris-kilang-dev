# HRIS Kilang — Antigravity Offline Source Workspace

## 1. Tentang repository ini

Repository ini merupakan **workspace dokumentasi, analisis, dan penyusunan perubahan source code HRIS Kilang** yang dipindahkan secara manual dari generator lama ke Antigravity.
...
Repository ini **bukan salinan aplikasi Laravel lengkap**, bukan repository deployment, dan bukan environment runtime HRIS Kilang.
...
- server development HRIS Kilang;
- server production HRIS Kilang;
- server QL;
...
Perubahan yang dibuat di dalam repository ini **tidak akan langsung mengubah aplikasi HRIS Kilang**. Semua penerapan perubahan harus dilakukan secara sadar dan manual oleh programmer yang memiliki kewenangan pada generator, repository, database, atau server tujuan.
...
Walaupun source code HRIS Kilang memiliki pola yang menyerupai Laravel, repository ini tidak dibangun sebagai project Laravel standar.
...
Tujuan utama repository ini adalah menyediakan peta source code yang rapi agar proses pemeliharaan HRIS Kilang dapat dilakukan dengan lebih terstruktur.
...
Salah satu masalah awal HRIS Kilang yang sedang dianalisis adalah error PostgreSQL:
...
workspace lokal
server ql
server development Kilang
server production Kilang
```
...
- fitur berhasil di server QL tetapi error di server Kilang;
...
environment: server development Kilang
...
> Repository ini adalah workspace source code offline untuk membantu programmer menganalisis dan menyiapkan perbaikan HRIS Kilang menggunakan Antigravity.
>
...
>
> Tidak ada perubahan yang diterapkan otomatis ke sistem HRIS Kilang.
>
